...
import com.myuserbackend.model.request.UserLoginRequest;
import com.myuserbackend.model.request.UserRegisterRequest;
import com.myuserbackend.model.dto.PageResult;
...
public class UserController {
     ...
     */
    @PostMapping("/delete")
    public BaseResponse<Boolean> deleteUser(@RequestBody com.myuserbackend.model.request.DeleteAccountRequest deleteRequest, HttpServletRequest request) {
        if (!isAdmin(request)) {
