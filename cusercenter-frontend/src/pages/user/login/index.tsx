...
import {Alert, App, message, Divider, Space, Tabs} from 'antd';
...
const LoginFormContent: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      setUserLoginState({ status: 'error', type, currentAuthority: undefined } as any);
    } catch (error) {
      const errMsg = (error as any)?.message || '登录失败，请重试！';
    ...
    <div className={styles.container}>
      ...
      >
        <LoginForm
          ...
          title="用户管理系统"
          subTitle={<a href={BEAR_LINK} target="_blank" >'熊的介绍'</a>}
          initialValues={{
            autoLogin: true,
          }}
